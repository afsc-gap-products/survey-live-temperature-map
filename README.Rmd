...
temp <- list.files(path = "./test/", pattern = string_id, full.names = TRUE)
temp <- data.frame(
  ...
  dplyr::mutate(
    ...
    srvy = gsub(pattern = paste0("/test/", string_id), replacement = "", x = srvy),
...
# [RACE Groundfish and Crab Live Survey Temperature Maps](`r link_repo`) <img src="https://avatars.githubusercontent.com/u/91760178?s=96&amp;v=4" alt="Logo." align="right" width="139" height="139"/>
...
And previously, **Caitlin Allen Akselrud** (caitlin.allen_akselrud AT noaa.gov; [\@CaitlinAkselrud-NOAA](https://github.com/CaitlinAkselrud-NOAA))
...
**Learn more about these surveys and ocean temperatures around Alaska** [@2021NEBS2022; @2018EBS2022; @2019NEBS2022; @2022NEBS2022; @AI2018; @GOA2018; @RohanColdPool]
