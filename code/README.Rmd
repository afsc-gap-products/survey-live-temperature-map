...
You will need to install https://www.ffmpeg.org/download.html#build-windows so video files can compile using the `magick` package, which works well with Task Scheduler.
