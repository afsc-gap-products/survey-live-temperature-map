...
temp <- list.files(path = "./examples/", pattern = string_id, full.names = TRUE)
temp <- data.frame(
  ...
  dplyr::mutate(
    ...
    srvy = gsub(pattern = paste0("/examples/", string_id), replacement = "", x = srvy),
...
**Learn more about these surveys and ocean temperatures around Alaska** [@2021NEBS2022; @2018EBS2022; @2019NEBS2022; @2022NEBS2023; @AI2018; @GOA2018; @RohanColdPool]
