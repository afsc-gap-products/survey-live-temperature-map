...
if (file_end %in% c("mean", "anom")) {
  
    temp1<-unique(dat_plot$reg_lab[!is.na(dat$reg_shapefile)])
  
    fig_cap <- fig_alt <- paste0(
    gsub(pattern = "\n", replacement = paste0(", comparing bottom temperatures from ", maxyr, " to "), x = plot_title), 
